...
clf = RandomForestClassifier(max_leaf_nodes=6)
...
clf = RandomForestClassifier(criterion='entropy', min_samples_split=3)
clf = clf.fit(train_X, train_Y)
...
clf = RandomForestClassifier(criterion='entropy', min_samples_split=4)
clf = clf.fit(train_X, train_Y)
...
clf = RandomForestClassifier(min_weight_fraction_leaf=0.1)
clf = clf.fit(train_X, train_Y)
...
clf = RandomForestClassifier(min_weight_fraction_leaf=0.3)
clf = clf.fit(train_X, train_Y)
